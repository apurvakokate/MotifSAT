...
DEFAULT_EXPERIMENT_LABELS = {
    ...
    'no_info_loss': 'No L_info (coef 0); 011; base vs max_mean readout sampling',
    'no_info_loss_deterministic_attn': 'No L_info; 011; σ(logits) only (no Concrete); base vs max_mean',
    ...
    'motif_readout_beta0.2_r0.7': 'Unweighted max||mean motif readout; alpha_uv=alpha_u*alpha_v; motif KL with beta=0.2, r=0.7',
    'motif_readout_beta0.2_r0.7_deterministic': 'Same beta=0.2, r=0.7 motif readout but deterministic alpha_v=sigma(logit_v)',
    'motif_readout_beta0.3_r0.6_mean': 'Motif readout beta=0.3, final_r=0.6 with graph pooling forced to mean across backbones',
    'motif_readout_beta0.3_r0.8': 'Motif readout beta=0.3, final_r=0.8 with add graph pooling (111 injection)',
    'motif_readout_beta0.3_r0.8_info0_sweep': 'Beta readout final_r=0.8 with info_loss=0; sweep node/motif perturbation, add/mean pooling, and sampling temperature',
    'motif_readout_info0_motif_noise_add_temp1_compare_rerun': 'Compare: beta readout clamped vs unclamped + base GSAT decay final_r=0.7',
    'motif_readout_info0_motif_noise_add_temp1_compare_gt_only': 'Compare (GT-only): beta readout clamped vs unclamped + base GSAT decay final_r=0.7',
    'maxmean_clamped_111_eval_fixed': 'Maxmean clamped (111) rerun after eval/train mode fixes; sweep info_coef 0.3/0.0',
    ...
    'maxmean_clamped_size_norm': 'Maxmean clamped (010) with size-normalized motif info loss; sweep info_coef 0.3/0.0',
    'maxmean_unclamped_111': 'Maxmean unclamped (111), final_r=0.6, info_coef=0.3, size-normalized motif info loss',
