...
DEFAULT_EXPERIMENT_LABELS = {
    ...
    'no_info_loss': 'No L_info (coef 0); 010; base vs max_mean readout sampling',
    'no_info_loss_deterministic_attn': 'No L_info; 010; σ(logits) only (no Concrete); base vs max_mean',
