...
Active groups (EXPERIMENT_GROUPS):
  ...
  test_gradient_info_coef0.2_tau2_raw_local — raw-local motif gate: x_v -> h_m/h_nbr -> p_m; single weighted GNN; pred+info
  test_gradient_info_coef0.2_tau2_node_superset — node-level superset leakage context (raw + detached GNN + leaked raw motifs)
  test_gradient_factored_between_within_tau2 — unweighted GNN -> ell_m(mean||max) + delta_v(raw intra); pred + 0.15 motif-KL + 0.05 node-KL
...
EXPERIMENT_GROUPS = {
    ...
    'test_gradient_info_coef0.2_tau2_raw_local': {
        'experiment_name': 'test_gradient_info_coef0.2_tau2_raw_local',
        'variants': [
            {
                'variant_id': 'rawlocal_inj111_info0.2_tau2',
                'gsat_overrides': {
                    'tuning_id': 'rawlocal_inj111_info0.2_tau2',
                    **_DECAY_R_BASE,
                    'final_r': 0.8,
                    'motif_incorporation_method': 'raw_local',
                    'motif_level_sampling': True,
                    'motif_level_info_loss': True,
    ...
    'test_gradient_info_coef0.2_tau2_node_superset': {
        'experiment_name': 'test_gradient_info_coef0.2_tau2_node_superset',
        'variants': [
            {
                'variant_id': 'rawnodesuperset_inj111_info0.2_tau2',
                'gsat_overrides': {
                    'tuning_id': 'rawnodesuperset_inj111_info0.2_tau2',
                    **_DECAY_R_BASE,
                    'final_r': 0.8,
                    'motif_incorporation_method': 'raw_node_superset',
                    'motif_level_sampling': True,
                    'motif_level_info_loss': True,
                    'use_raw_score_loss': True,
                    'motif_loss_coef': 0,
    ...
    'test_gradient_factored_between_within_tau2': {
        'experiment_name': 'test_gradient_factored_between_within_tau2',
        'variants': [
            {
                'variant_id': 'factored_between_within_inj111_tau2',
                'gsat_overrides': {
                    'tuning_id': 'factored_between_within_inj111_tau2',
                    **_DECAY_R_BASE,
                    'final_r': 0.8,
                    'motif_incorporation_method': 'factored_between_within',
                    'motif_level_sampling': True,
                    'motif_level_info_loss': False,
                    'use_raw_score_loss': True,
                    'motif_loss_coef': 0,
                    'between_motif_coef': 0,
                    'pred_loss_coef': 1.0,
                    'info_loss_coef': 0.0,
                    'between_motif_info_coef': 0.15,
                    'within_node_info_coef': 0.05,
                    'attention_sampling_temp': 2.0,
                    'motif_grad_probe': True,
                    'motif_grad_probe_every': 1,
                    'motif_grad_probe_max_batches': 1,
